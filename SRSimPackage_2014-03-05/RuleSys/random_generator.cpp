//
// C++ Implementation: random_generator
//
// Description: 
//
//
...
void RandomGenerator::init (int seed)
  ...
  if (seed <= 0 || seed > 900000000)
     SRError::critical ("RandomGenerator::init","bad seed value.");
  if (inited)  
     SRError::critical ("RandomGenerator::init","trying to init a second time!");
